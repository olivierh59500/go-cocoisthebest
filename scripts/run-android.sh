...
go run github.com/hajimehoshi/ebiten/v2/cmd/ebitenmobile@v2.9.11 \
    ...
    -androidapi 23 \
    -javapkg com.olivierh.cocoisthebest \
    -o android/app/libs/cocoisthebest.aar \
    ./mobile
...
echo "→ Lancement de COCO IS THE BEST"
$adb_path shell am force-stop com.olivierh.cocoisthebest
$adb_path shell am start -n com.olivierh.cocoisthebest/.MainActivity
